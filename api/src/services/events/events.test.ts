...
describe('events', () => {
  ...
  scenario('creates a event', async () => {
    const result = await createEvent({
      input: {
        name: 'String',
        dateTime: '2023-12-09T21:25:41.630Z',
        date: '2023-12-09T21:25:41.630Z',
      },
    })

    expect(result.name).toEqual('String')
    expect(result.dateTime).toEqual(new Date('2023-12-09T21:25:41.630Z'))
    expect(result.date).toEqual(new Date('2023-12-09T21:25:41.630Z'))
  })
